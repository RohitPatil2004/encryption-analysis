#!/bin/bash
# experiments/run_h2h_highload.sh  -  Member 1
# High-load: 100 parallel iperf3 streams, 60 sec, 3 runs per hop count
# Usage: sudo bash experiments/run_h2h_highload.sh
 
set -e
PARALLEL=100 ; DURATION=60 ; RUNS=3 ; ENC_TYPE="h2h"
